...
let birthyear = parseInt(prompt("Birthyear?", "2006"));
...
function feeling() {
    ...
    switch (feeling.toLowerCase()) {
        case "good":
        console.log("Glad to hear that you're feeling good!");
        break;
    case "bad":
        console.log("I'm sorry to hear that you're feeling bad.");
        break;
    case "ok":
        console.log("Okay is better than bad, at least.")
        break;        
    }
}
feeling();
